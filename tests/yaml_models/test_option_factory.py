"""Tests for ColumnOption factory methods and validation."""
...
class TestColumnOptionFromRaw:
    """Test cases for ColumnOptionBase.from_raw factory method."""

    def test_plain_string(self) -> None:
        """Verify plain strings are parsed as STRING type."""
    ...
    def test_non_string_primitives(
        ...
        """Verify non-string primitives are detected correctly."""
    ...
    def test_prefixed_primitives(
        ...
        """Verify prefixed type expressions are parsed correctly."""
...
class TestColumnOptionTimestamp:
    """Test cases for timestamp option parsing."""

    def test_timestamp_integer(self) -> None:
        """Verify integer timestamp is parsed correctly."""
    ...
    def test_timestamp_iso(self) -> None:
        """Verify ISO timestamp is converted to integer."""
...
class TestColumnOptionReference:
    """Test cases for reference option parsing."""

    def test_reference(self) -> None:
        """Verify reference option is parsed correctly."""
...
class TestColumnOptionEdgeCases:
    """Test cases for edge cases and error handling."""

    def test_multiple_prefixes_treated_as_string(self) -> None:
        """Verify multiple prefixes are treated as plain string."""
    ...
    def test_serialize_roundtrip(self) -> None:
        """Verify serialize produces valid input for from_raw."""
